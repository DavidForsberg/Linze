...
const Setup = () => {
  ...
  return (
    <Layout>
      <div className="items-center justify-center md:w-11/12 text-center md:flex w-full">
        <div className="bg-alternative md:flex rounded-2xl shadow-2xl md:w-11/12 md:max-w-4xl">
          <div className="md:w-3/5 py-12 px-6 md:px-14 bg-gradient-to-b md:bg-gradient-to-t from-alternative to-bg md:rounded-tl-2xl md:rounded-bl-2xl">
            <label className="text-primary font-bold text-lg">
              User settings
            </label>
            <div className="font-bold text-alternative my-4">
              <Formik
                  ...
                  <Form onSubmit={handleSubmit} className="flex flex-col">
                    <div className="flex flex-col space-y-6">
                      ...
                      <Field
                        ...
                        component={InputField}
                      />
                      <div className="flex flex-col md:flex-row text-center md:justify-between md:items-center md:space-y-0 space-y-6">
                        <Field
                          className="rounded px-4 py-1 placeholder:text-alternative focus:ring-2 ring-alternative outline-none"
                          name="day"
                          component="select"
          ...
          <div className="md:w-2/5 bg-gradient-to-t from-alternative to-bg md:rounded-tr-2xl md:rounded-br-2xl py-12 px-14 text-primary">
            <label className="font-bold text-lg">Profile picture</label>
            <div className="w-full py-6">
              <img
                className={` shadow-2xl ring-primary rounded ${
            ...
            >
              {(handleSubmit) => (
                <Form>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-primary text-alternative rounded-2xl hover:ring-2 hover:bg-alternative hover:ring-primary hover:text-primary py-2 px-6 duration-100 mt-5 font-bold hover:shadow-2xl"
                  >
                    Submit
                  </button>
                </Form>
